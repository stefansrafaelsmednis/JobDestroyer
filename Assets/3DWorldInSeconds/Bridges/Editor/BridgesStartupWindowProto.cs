    ...
    public class BridgesStartupWindowProto : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.BeginVertical();
            {
                ...
                // URP Warning
                if (UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline != null && UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline.GetType().Name == "UniversalRenderPipelineAsset")
                {
                    // URP Warning
